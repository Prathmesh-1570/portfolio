...
const Contact = ({isDarkMode}) => {
    ...
    return (
        ...
        bg-no-repeat bg-center bg-[length:90%_auto] dark:bg-none'>
            ...
            I'd love to hear from you! If you have any questions, feedback, or comments, 
        ...
        onSubmit={onSubmit} className='max-w-2xl mx-auto'>
            ...
            text-white rounded-full mx-auto hover:bg-black duration-500 dark:bg-transparent dark:border-[0.5px] dark:hover:bg-darkHover'>Submit now <Image src={assets.right_arrow_white} alt='' className='w-4'/>
            </motion.button>
