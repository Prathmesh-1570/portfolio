...
const Services = ({isDarkMode}) => {
    return (
        ...
        I provide professional web and mobile app development, specializing in responsive designs and modern technologies 
        like React and Node.js. My expertise includes database management, 
        full-stack development, and custom software solutions tailored to your unique needs.
        </motion.p>
